...
import { Paper, Theme, withStyles, Grid } from '@material-ui/core';
...
class Layout extends React.Component<ILayoutProps, INavMenu> {
    public state = {
        isCollapse: false
    }
    ...
    public render() {
        ...
        return (<>
            ...
            {/* <div className={`page-sidebar-fixed page-header-fixed page-container ${this.state.isCollapse ? 'page-sidebar-collapsed' : ''}`}>
                <NavMenu />
