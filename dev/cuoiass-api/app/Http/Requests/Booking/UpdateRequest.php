...
class UpdateRequest extends RequestAbstract
{
    ...
    public function rules()
    {
        $rule = [
            ...
            'foods.*.booked_total' => ['required_with:foods','integer',"digits_between:0,11"],
            ...
            'drinks.*.booked_total' => ['required_with:drinks','integer',"digits_between:0,11"],
            ...
            'options.news.*.option_quality' => ['required_with:options.news','integer',"digits_between:0,11"],
            ...
            'options.updates.*.option_quality' => ['required_with:options.updates','integer',"digits_between:0,11"],
